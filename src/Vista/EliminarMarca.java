...
public class EliminarMarca extends javax.swing.JFrame {
    ...
    public EliminarMarca(Controlador importado) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Eliminar Marca");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        for(Marca marca: controlador.getListas().getListaDeMarcas()){
            if(marca.getMarca().equals(this.jComboBox1.getSelectedItem())){
                ...
                controlador.getListas().getListaDeMarcas().remove(indice);
                JOptionPane.showConfirmDialog(null, "La marca se eliminó correctamente.",
                "Marca eliminada", JOptionPane.CLOSED_OPTION,
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EliminarMarca(new Controlador()).setVisible(true);
            }
        });
    }
